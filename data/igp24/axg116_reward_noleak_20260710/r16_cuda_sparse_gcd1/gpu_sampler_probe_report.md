...
- Created UTC: `2026-07-10T07:44:01.558642+00:00`
- Output directory: `/home/zpconn/code/igp24-axplorer/data/igp24/axg116_reward_noleak_20260710/r16_cuda_sparse_gcd1`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 27.475 | cuda | 3 | 0.013 | 0.303 | 34.000 | 90.000 | 29.538 | True | 151 | 4 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 512 | 151 | 4 | 4 | 29 | attempt_budget_exhausted | /home/zpconn/code/igp24-axplorer/data/igp24/axg116_reward_noleak_20260710/r16_cuda_sparse_gcd1/gpu_model_sample_export_target_r16_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 16 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 151}` |
