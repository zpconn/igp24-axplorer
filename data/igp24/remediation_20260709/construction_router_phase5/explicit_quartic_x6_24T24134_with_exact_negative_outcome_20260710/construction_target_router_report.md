...
- Created: `2026-07-10T05:17:39.145953+00:00`
...
- Executable-generator routes: `1`
- Generation-ready routes: `0`
- Blocking reasons: `{'unsupported_target_r': 2}`
- Generation-ready blockers: `{'adaptive_target_exclusion_not_run': 5, 'exact_route_false_target_outcome': 1, 'executable_generator_not_bound_to_target': 4, 'generated_outputs_not_validated': 5, 'generator_block_structure_not_matched_to_target': 1, 'structure_preservation_not_verified': 4, 'target_parameters_not_instantiated': 4, 'unsupported_target_r': 2}`
...
| ---: | --- | --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `24T24134|r=8` | `tower_6x4` | 788.0 | `True` | `False` | `structurally_eligible` | `False` | - | executable_generator_not_bound_to_target, structure_preservation_not_verified, target_parameters_not_instantiated, generated_outputs_not_validated, adaptive_target_exclusion_not_run | - | - |
| 2 | `24T24134|r=8` | `composition_8x3` | 788.0 | `True` | `False` | `structurally_eligible` | `False` | - | executable_generator_not_bound_to_target, structure_preservation_not_verified, target_parameters_not_instantiated, generated_outputs_not_validated, adaptive_target_exclusion_not_run | - | - |
