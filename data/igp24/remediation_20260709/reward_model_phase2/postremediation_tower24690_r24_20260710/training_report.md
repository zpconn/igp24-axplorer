...
- Created UTC: `2026-07-10T08:54:52.561714+00:00`
- Source dataset: `data/igp24/active_learning/axg_training_dataset_20260710_postremediation_tower24690_r24.jsonl`
- Rows: `523`
- Advisory status: `advisory_insufficient_positive_data`
- Train rows: `410`
- Eval rows: `113`
- Train/eval group overlap: `[]`
- Outcome counts: `{"crowded_accepted_collapse": 388, "no_valuable_target_survival": 74, "score_positive": 8, "unknown": 14, "wrong_r": 39}`

## Eval Metrics

- Supervised eval rows: `113`
- Unknown eval rows excluded: `0`
- Mean uncertainty entropy: `0.284`
- Abstention rate: `0.044`
...
| `crowded_accepted_collapse` | 1.000 | 0.866 | 0.928 | 67 |
| `invalid` | 0.000 | 0.000 | 0.000 | 0 |
| `low_team_scoreable` | 0.000 | 0.000 | 0.000 | 0 |
| `no_valuable_target_survival` | 0.000 | 0.000 | 0.000 | 40 |
| `score_positive` | 0.000 | 0.000 | 0.000 | 0 |
| `wrong_r` | 0.130 | 1.000 | 0.231 | 6 |

## Uncertainty

- All-record evaluated rows: `509`
- All-record mean entropy: `0.136`
- All-record abstention rate: `0.024`

## Positive vs Crowded Diagnostic

- Score-positive rows: `8`
- Crowded-collapse rows: `388`
- Total collapse-risk rows: `501`
- Mean positive reward probability: `0.716`
- Mean crowded reward probability: `0.044`
- Mean collapse-risk reward probability: `0.062`
