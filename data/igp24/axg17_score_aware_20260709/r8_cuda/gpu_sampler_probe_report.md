...
- Created UTC: `2026-07-09T17:46:13.354650+00:00`
- Output directory: `/home/zpconn/code/igp24-axplorer/data/igp24/axg17_score_aware_20260709/r8_cuda`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 128.059 | cuda | 12 | 0.040 | 3.208 | 34.000 | 91.000 | 75.484 | True | 492 | 12 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 4096 | 492 | 12 | 12 | 1243 | attempt_budget_exhausted | /home/zpconn/code/igp24-axplorer/data/igp24/axg17_score_aware_20260709/r8_cuda/gpu_model_sample_export_target_r8_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 8 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 492}` |
