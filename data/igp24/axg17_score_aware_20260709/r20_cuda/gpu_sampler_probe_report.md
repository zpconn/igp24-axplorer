...
- Created UTC: `2026-07-09T17:58:01.629178+00:00`
- Output directory: `/home/zpconn/code/igp24-axplorer/data/igp24/axg17_score_aware_20260709/r20_cuda`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 141.067 | cuda | 12 | 0.040 | 3.549 | 34.000 | 89.000 | 74.507 | True | 265 | 8 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 4096 | 265 | 8 | 8 | 1945 | attempt_budget_exhausted | /home/zpconn/code/igp24-axplorer/data/igp24/axg17_score_aware_20260709/r20_cuda/gpu_model_sample_export_target_r20_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 20 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 265}` |
