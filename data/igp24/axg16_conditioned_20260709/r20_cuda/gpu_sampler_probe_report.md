...
- Created UTC: `2026-07-09T15:47:18.195447+00:00`
- Output directory: `/home/zpconn/code/igp24-axplorer/data/igp24/axg16_conditioned_20260709/r20_cuda`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 192.771 | cuda | 18 | 0.038 | 2.728 | 34.000 | 89.000 | 78.021 | True | 310 | 8 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 4096 | 310 | 8 | 8 | 1490 | attempt_budget_exhausted | /home/zpconn/code/igp24-axplorer/data/igp24/axg16_conditioned_20260709/r20_cuda/gpu_model_sample_export_target_r20_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 20 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 310}` |
