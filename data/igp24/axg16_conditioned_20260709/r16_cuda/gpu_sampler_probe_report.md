...
- Created UTC: `2026-07-09T15:43:33.799849+00:00`
- Output directory: `/home/zpconn/code/igp24-axplorer/data/igp24/axg16_conditioned_20260709/r16_cuda`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 194.571 | cuda | 18 | 0.040 | 2.637 | 34.000 | 89.000 | 77.400 | True | 276 | 10 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 4096 | 276 | 10 | 10 | 647 | attempt_budget_exhausted | /home/zpconn/code/igp24-axplorer/data/igp24/axg16_conditioned_20260709/r16_cuda/gpu_model_sample_export_target_r16_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 16 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 276}` |
