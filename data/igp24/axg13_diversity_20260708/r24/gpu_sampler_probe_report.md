...
- Created UTC: `2026-07-08T03:03:43.806670+00:00`
- Output directory: `/tmp/igp24_axg13_diversity_20260708/r24`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 157.006 | cuda | 16 | 0.036 | 5.335 | 34.000 | 91.000 | 79.737 | True | 200 | 91 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 2048 | 200 | 91 | 91 | 1848 | attempt_budget_exhausted | /tmp/igp24_axg13_diversity_20260708/r24/gpu_model_sample_export_target_r24_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 24 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 200}` |
