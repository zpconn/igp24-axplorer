...
- Created UTC: `2026-07-08T02:57:47.733008+00:00`
- Output directory: `/tmp/igp24_axg13_diversity_20260708/r16`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 151.952 | cuda | 16 | 0.035 | 5.455 | 34.000 | 92.000 | 79.527 | True | 161 | 89 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 2048 | 161 | 89 | 89 | 1887 | attempt_budget_exhausted | /tmp/igp24_axg13_diversity_20260708/r16/gpu_model_sample_export_target_r16_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 16 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 161}` |
