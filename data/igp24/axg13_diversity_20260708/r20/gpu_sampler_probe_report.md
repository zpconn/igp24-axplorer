...
- Created UTC: `2026-07-08T03:00:35.589282+00:00`
- Output directory: `/tmp/igp24_axg13_diversity_20260708/r20`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 172.524 | cuda | 16 | 0.036 | 5.545 | 34.000 | 87.000 | 77.262 | True | 221 | 83 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 2048 | 221 | 83 | 83 | 1827 | attempt_budget_exhausted | /tmp/igp24_axg13_diversity_20260708/r20/gpu_model_sample_export_target_r20_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 20 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 221}` |
