...
- Created UTC: `2026-07-08T01:57:04.916286+00:00`
- Output directory: `/tmp/igp24_axg11_target_r_seeded_20260707/r24`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 27.407 | cuda | 2 | 0.765 | 0.722 | 14.000 | 83.000 | 7.385 | True | 516 | 513 | 0 | 0 | 0 | 455 | True |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 512 | 516 | 513 | 513 | 0 | attempt_budget_exhausted | /tmp/igp24_axg11_target_r_seeded_20260707/r24/gpu_model_sample_export_target_r24_seeded.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| True | 24 | 4 | 4 | 4 | 0 | 0 | 547090 | `{"model_generate": 512, "target_r_seed_bank": 4}` |
