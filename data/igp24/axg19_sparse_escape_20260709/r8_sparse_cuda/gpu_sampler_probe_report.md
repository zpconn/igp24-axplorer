...
- Created UTC: `2026-07-09T19:03:20.610540+00:00`
- Output directory: `/home/zpconn/code/igp24-axplorer/data/igp24/axg19_sparse_escape_20260709/r8_sparse_cuda`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 154.949 | cuda | 12 | 0.039 | 3.628 | 34.000 | 87.000 | 66.987 | True | 1171 | 8 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 8192 | 1171 | 8 | 8 | 1362 | attempt_budget_exhausted | /home/zpconn/code/igp24-axplorer/data/igp24/axg19_sparse_escape_20260709/r8_sparse_cuda/gpu_model_sample_export_target_r8_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 8 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 1171}` |
