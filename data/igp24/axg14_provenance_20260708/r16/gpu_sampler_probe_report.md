...
- Created UTC: `2026-07-08T03:44:32.914598+00:00`
- Output directory: `/tmp/igp24_axg14_provenance_20260708/r16`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 237.094 | cuda | 24 | 0.032 | 5.781 | 34.000 | 87.000 | 77.130 | True | 90 | 16 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 3072 | 90 | 16 | 16 | 1251 | attempt_budget_exhausted | /tmp/igp24_axg14_provenance_20260708/r16/gpu_model_sample_export_target_r16_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 16 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 90}` |
