...
- Created UTC: `2026-07-08T04:02:46.887672+00:00`
- Output directory: `/tmp/igp24_axg14_provenance_20260708/r12`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 230.415 | cuda | 24 | 0.034 | 5.798 | 34.000 | 88.000 | 76.848 | True | 97 | 22 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 3072 | 97 | 22 | 22 | 1056 | attempt_budget_exhausted | /tmp/igp24_axg14_provenance_20260708/r12/gpu_model_sample_export_target_r12_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 12 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 97}` |
