...
- Created UTC: `2026-07-08T03:54:13.426502+00:00`
- Output directory: `/tmp/igp24_axg14_provenance_20260708/r20`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 241.067 | cuda | 24 | 0.032 | 5.849 | 34.000 | 86.000 | 76.145 | True | 122 | 35 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 3072 | 122 | 35 | 35 | 2917 | attempt_budget_exhausted | /tmp/igp24_axg14_provenance_20260708/r20/gpu_model_sample_export_target_r20_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 20 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 122}` |
