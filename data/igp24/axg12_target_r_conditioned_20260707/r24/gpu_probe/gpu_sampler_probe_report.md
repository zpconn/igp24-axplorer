...
- Created UTC: `2026-07-08T02:34:10.678709+00:00`
- Output directory: `/tmp/igp24_axg12_target_r_conditioned_20260707/r24`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 75.010 | cuda | 8 | 0.038 | 4.621 | 34.000 | 94.000 | 81.639 | True | 132 | 74 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 768 | 132 | 74 | 74 | 636 | attempt_budget_exhausted | /tmp/igp24_axg12_target_r_conditioned_20260707/r24/gpu_model_sample_export_target_r24_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 24 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 132}` |
