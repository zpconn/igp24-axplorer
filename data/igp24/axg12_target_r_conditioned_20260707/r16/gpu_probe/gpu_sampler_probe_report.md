...
- Created UTC: `2026-07-08T02:31:01.012657+00:00`
- Output directory: `/tmp/igp24_axg12_target_r_conditioned_20260707/r16`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 73.991 | cuda | 8 | 0.040 | 4.872 | 34.000 | 92.000 | 81.028 | True | 41 | 35 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 768 | 41 | 35 | 35 | 727 | attempt_budget_exhausted | /tmp/igp24_axg12_target_r_conditioned_20260707/r16/gpu_model_sample_export_target_r16_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 16 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 41}` |
