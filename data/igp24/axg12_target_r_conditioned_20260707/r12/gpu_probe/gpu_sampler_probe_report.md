...
- Created UTC: `2026-07-08T02:29:27.483135+00:00`
- Output directory: `/tmp/igp24_axg12_target_r_conditioned_20260707/r12`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 80.912 | cuda | 8 | 0.037 | 4.642 | 34.000 | 92.000 | 78.590 | True | 159 | 85 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 768 | 159 | 85 | 85 | 609 | attempt_budget_exhausted | /tmp/igp24_axg12_target_r_conditioned_20260707/r12/gpu_model_sample_export_target_r12_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 12 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 159}` |
