...
- Created UTC: `2026-07-09T18:24:09.504573+00:00`
- Output directory: `/home/zpconn/code/igp24-axplorer/data/igp24/axg18_escape_20260709/r24_cuda`
...
- Dedup unique target: `320`
- Dedup attempt budget: `3072`
...
| ---: | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | False | False | 112.027 | cuda | 10 | 0.040 | 3.289 | 34.000 | 86.000 | 73.056 | True | 328 | 6 | 0 | 0 | 0 | 0 | False |

## Sample Export Dedup

| dedup_enabled | attempted | written | decoded_written | unique_decoded | duplicate_skipped | stop_reason | summary |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| True | 3072 | 328 | 6 | 6 | 725 | attempt_budget_exhausted | /home/zpconn/code/igp24-axplorer/data/igp24/axg18_escape_20260709/r24_cuda/gpu_model_sample_export_target_r24_conditioned.jsonl.summary.json |

## Target-r Seed Bank

| enabled | target_r | limit | written | matching_rows | duplicate_skipped | invalid_skipped | max_height | source_counts |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| False | 24 | 0 | 0 | 0 | 0 | 0 | None | `{"model_generate": 328}` |
